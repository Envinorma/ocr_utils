...
def test_group_cells_2():
    res = [
        ...
        DetectedCell(
            ...
            "ses pour l'environnement - À -, très toxiques pour\nles organismes "
            "aquatiques, telles que définies à la rubrique\n1000, à l'exclusion "
            "de celles visées nominativement ou par\nfamille par d'autres rubriques\n\x0c",
        ...
        DetectedCell(
            ...
            'briques 167C et 322 B4.\n\nLa puissance thermique maximale est défi'
            'nie comme la\nquantité maximale de combustible, exprimée en PCI,\nsu'
            'sceptible d’être consommée par seconde.\n\nA) Lorsque l’installatio'
            'n consomme exclusivement, seuls\nou en mélange du gaz naturel, des '
            'gaz de pétrole liquéfiés,\ndu fioul domestique, du charbon, des fi'
            'ouls lourds ou la\nbiomasse, à l’exclusion des installations visées'
            ' par d’autres\nrubriques de la nomenclature pour lesquelles la comb'
            'ustion\nparticipe à la fusion, la cuisson ou au traitement, en\nmél'
            'ange avec les gaz de combustion, des matières entrantes,\nsi la pui'
            'ssance thermique maximale de l’installation est :\n\n2. — supérieur'
            'e à 2 MW, mais inférieure à 20 MW\n\x0c',
